...
\begin{tabularx}{\textwidth} { 
  ...
  >{\raggedleft\arraybackslash}X }
    ...
    \end{tabular} 
\end{tabularx}
% This file should contain the main heading of the resume: name, contact info, and any header formatting. Edit here to change your displayed identity and contact details.
